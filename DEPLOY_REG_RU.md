...
Если вы публиковали **Telegram BOT_TOKEN** — **срочно отзовите/перевыпустите токен в BotFather**, иначе бот скомпрометирован.
...
Также скрипт может **сам настроить Telegram-переменные** для `notify.php` (ввод скрыт).
