        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {articles.map((article) => (
            <Link
              key={article.id}
              href={article.url}
              className={`bg-white rounded-none ${article.id === 2 ? 'pt-0 sm:pt-1' : 'pt-4 sm:pt-5'} px-4 sm:px-5 pb-0 shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)] transition-shadow group flex flex-col min-h-[280px] sm:min-h-[300px]`}
            >
              {/* Publication logo/name */}
              <div className={article.id === 2 ? 'mb-0 -ml-2 sm:ml-0' : 'mb-3'}>
