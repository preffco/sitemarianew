...
const articles = [
  {
    ...
    title: "По прогнозам экспертов, следующим этапом развития мессенджеров станут ИИ-агенты, и первыми эту нишу займут компании из Азии. Россия останется в стороне, если не предложит свой «умный» суперапп. Спасет ли ситуацию МАХ — объясняет Мария Аникина (Ai for all)",
              ...
              <div className="mb-3">
                {article.publicationLogo ? (
                  <Image
                    ...
                    width={120}
                    height={40}
                    className="h-8 w-auto object-contain brightness-0 opacity-85"
                  />
                ) : (
