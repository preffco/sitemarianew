          ...
          <div className="hidden lg:flex gap-6 justify-end">
            <div className="flex flex-col gap-4">
              <div className="rounded-3xl bg-white px-8 py-6 shadow-[0_25px_80px_rgba(0,0,0,0.25)] border border-black/5">
                ...
                <p className="mt-3 text-[#1d9bf0] text-sm leading-relaxed">Структурируем задачи, находим точки роста.</p>
              </div>
              <div className="rounded-3xl bg-white px-8 py-6 shadow-[0_15px_40px_rgba(0,0,0,0.15)] border border-black/5">
                ...
                <p className="mt-3 text-[#1d9bf0] text-sm leading-relaxed">Под ключ, интеграции в CRM и чаты.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4 mt-6">
              <div className="rounded-3xl bg-white px-8 py-6 shadow-[0_20px_60px_rgba(0,0,0,0.25)] border border-black/5">
                ...
                <p className="mt-3 text-[#1d9bf0] text-sm leading-relaxed">Автоматизация лидов, задач и сопровождения.</p>
              </div>
              <div className="rounded-3xl bg-white px-8 py-6 shadow-[0_20px_60px_rgba(0,0,0,0.25)] border border-black/5">
                <div className="flex items-center justify-between gap-4">
                ...
                <p className="mt-3 text-[#1d9bf0] text-sm leading-relaxed">Проектируем решения с учетом норм.</p>
              </div>
            </div>
          </div>
        </div>
